...
軟體工程師，具備工具平台開發、視覺化應用、全端系統與 CI/CD 自動化的實戰經驗，累積近 3 年產品開發經驗，代表成果包含 CI/CD 自動化測試流程重構與規格解析工具開發。
擅長根因分析與系統重構，能將不穩定問題轉為可維護、可自動化的工程解法。
近期也以 AI Agent 工作流與 Function Calling 為工具，應用於全端 PWA 開發。
